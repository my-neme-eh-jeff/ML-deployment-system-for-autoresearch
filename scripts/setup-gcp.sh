...
echo ""
echo "4. Bring up the cluster + workloads: make cluster-wake"
echo "   (then 'make reset-for-fresh-run' to register a fresh v1 baseline,"
echo "   and 'make autoresearch-run AUTORESEARCH_N=5' to launch the loop.)"
echo "====================================================================="
